...
import 'package:blog_app/features/blogs/presentation/pages/add_new_blog_page.dart';
...
class _BlogPageState extends State<BlogPage> {
  ...
  void initState() {
    super.initState();
    DependencyInjector.getIt<BlogBloc>().add(BlogGetAllEvent());
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("Blog Page"), actions: [
          IconButton(
            onPressed: () {
